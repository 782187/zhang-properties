      ...
      <div className="container py-5">
        ...
        >
          <motion.div className="col-lg-6" variants={itemVariants}>
            <div className="bg-white rounded-4 shadow-lg p-4 p-md-5 h-100 border-start border-5 border-warning">
          ...
          <motion.div className="col-lg-6" variants={itemVariants}>
            <div className="overflow-hidden rounded-4 h-100">
              <motion.img
                src="/build.jpeg"
          ...
          <motion.div className="col-lg-6 order-lg-2" variants={itemVariants}>
            <div className="bg-warning rounded-4 shadow-lg p-4 p-md-5 h-100 border-start border-5 border-dark">
              <div className="d-flex align-items-center mb-4">
          ...
          >
            <div className="position-relative">
              <div className="position-relative z-1">
                ...
                <div className="position-absolute bottom-0 start-0 bg-warning text-dark p-3 rounded-tr-4">
                  <h5 className="mb-0">Eco-Friendly Design</h5>
                </div>
              </div>
            </div>
          </motion.div>
                  ...
                  <div className="col-md-7">
                    <div className="p-4 p-xl-5 h-100 d-flex flex-column">
                      ...
                      <div className="mt-auto">
                        <Link to="/dropdown/welease" className="btn btn-warning px-4 py-3 fw-bold d-inline-flex align-items-center">
                          Explore Solutions 
                ...
                <div className="row g-0">
                  ...
                  <div className="col-md-7">
                    <div className="p-4 p-xl-5 h-100 d-flex flex-column">
                      ...
                      <div className="mt-auto">
                        <Link to="/dropdown/wemaintain" className="btn btn-warning px-4 py-3 fw-bold d-inline-flex align-items-center">
                          Explore Solutions 
                          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" className="ms-2">
                            <path fillRule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"/>
                          </svg>
