        ...
        >
          <motion.div className="col-lg-6" variants={itemVariants}>
            <div className="bg-white rounded-4 shadow-lg p-4 p-md-5 h-100">
              ...
              <p className="text-muted fs-5">In today's business landscape, accessing industrial facilities swiftly is crucial for manufacturing and warehousing companies to remain competitive. However, challenges such as limited construction expertise, high CAPEX commitments, compliance complexities, and locating prime locations can impede progress. Delays in facility development hinder scalability, market responsiveness, and incur additional costs.</p>
            </div>
          </motion.div>
