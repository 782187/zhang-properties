            ...
            >
                <div className="container text-center">
                    ...
                    <motion.p className="lead" variants={itemVariants}>
                        Tata Gotion is a landmark industrial development designed to meet the future of manufacturing and smart logistics. Spanning over 1.3 million sq.ft, it integrates advanced architecture, digital infrastructure, and green technologies to support cutting-edge industries.
                    </motion.p>
                </div>
            </motion.section>
