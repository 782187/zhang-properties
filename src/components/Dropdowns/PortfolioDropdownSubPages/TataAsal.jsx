        ...
        >
            ...
            >
                <div className="container text-center">
                    ...
                    <motion.p className="lead" variants={itemVariants}>
                        Tata Asal is a landmark industrial development designed to meet the future of manufacturing and smart logistics. Spanning over 1.3 million sq.ft, it integrates advanced architecture, digital infrastructure, and green technologies to support cutting-edge industries.
                    </motion.p>
                </div>
            </motion.section>
            ...
            >
                <div className="container">
                    <motion.h2 className="text-center mb-4 fw-bold text-warning" variants={itemVariants}>
            ...
            >
                <div className="container">
                    <motion.h2 className="text-center mb-5 text-warning fw-bold" variants={itemVariants}>
                        Gallery: Inside Tata Tata Asal
                    </motion.h2>
