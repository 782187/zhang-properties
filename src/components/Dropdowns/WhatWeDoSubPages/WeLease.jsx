          ...
          <motion.div className="col-lg-6" variants={itemVariants}>
            <div className="bg-white rounded-4 shadow-lg p-4 p-md-5 h-100">
              <div className="d-flex align-items-center mb-4">
                ...
                <h3 className="mb-0">Challenges of owning industrial real estate</h3>
              </div>
              <p className="text-muted fs-5">In the competitive landscape of modern industry, owning industrial real estate assets often demands a significant capital outlay, directing resources away from core business operations. Beyond the financial burden, the intricacies of property acquisition, design, development, and compliance adherence often deviate from the core competencies of many manufacturing entities.</p>
            </div>
          </motion.div>
          ...
          <motion.div className="col-lg-6 order-lg-2" variants={itemVariants}>
            <div className="bg-warning rounded-4 shadow-lg p-4 p-md-5 h-100">
              <div className="d-flex align-items-center mb-4">
                ...
                <h3 className="mb-0">Premium Industrial facilities on lease</h3>
              </div>
              <p className="fs-5">We have developed our industrial parks with a clear understanding of these challenges. We provide advanced and versatile leasing structures for industrial spaces, tailored to fit a range of business needs and scales. Our lease structures are designed to offer agility and strategic advantages, aligning with your business's growth trajectory. Our emphasis is on ensuring the entire process, from acquiring to adhering to compliances, is as seamless as possible.</p>
            </div>
          </motion.div>
          ...
          <motion.div className="col-lg-6" variants={itemVariants}>
            <div className="bg-white rounded-4 shadow-lg p-4 p-md-5 h-100">
              <div className="d-flex align-items-center mb-4">
                ...
                <h3 className="mb-0">Focussing on what matters most</h3>
              </div>
              <p className="text-muted fs-5">Our commitment is simple - we handle the real estate intricacies so you can zero in on your core business functions. We invest, design, and cultivate the perfect industrial space, freeing you to leverage your capital where it truly matters: in expanding and refining your core operations.</p>
            </div>
          </motion.div>
                ...
                <div className="row g-0">
                  ...
                  <div className="col-md-7">
                    <div className="p-4 p-xl-5 h-100 d-flex flex-column">
                      <h3 className="fw-bold mb-3">We Build</h3>
                      <p className="text-muted mb-4">Developing industrial parks with premium spaces tailored for your ambitions.</p>
                      <div className="mt-auto">
                        <Link to="/dropdown/webuild" className="btn btn-warning px-4 py-3 fw-bold">Explore Solutions</Link>
                      </div>
                    </div>
                  </div>
                </div>
