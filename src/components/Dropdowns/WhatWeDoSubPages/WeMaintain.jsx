  ...
  return (
    <div className="bg-light" style={{ fontFamily: "'Barlow', sans-serif" }}>
      ...
      <div className="container-xl mb-4">
        ...
        >
          Park Operations & Maintenance by Zhang
        </motion.h2>
      </div>
              ...
              <div className="row g-0 align-items-stretch">
                ...
                >
                  <div className="whatwedo-feature-text-block w-100">
                    ...
                    >
                      KEEPING YOUR PARKS RELIABLE, SAFE AND FUTURE-READY
                    </div>
                    <p
                      className="mb-0 text-white-50"
                      style={{ fontSize: '1.2rem', lineHeight: 1.7 }}
                    >
                      Zhang Properties stays invested in the daily performance of our industrial parks
                      through proactive maintenance, utilities management and common area operations.
                      Our on-ground teams manage landscape, safety systems, waste, lighting and core
                      infrastructure so occupiers experience consistent uptime. With clear SOPs and
                ...
                >
                  <div className="whatwedo-feature-image-wrapper">
                    <img src="/sany_chakan2.jpg" alt="Zhang facility maintenance and monitoring" className="water-float" />
                  </div>
                </motion.div>
              </div>
            </div>
              ...
              >
                <div className="whatwedo-feature-image-wrapper">
                  <img
                    ...
                    className="whatwedo-light-image water-float"
                  />
                </div>
              </motion.div>
            </div>
            ...
            <div className="position-relative">
              <div className="position-relative z-1">
                <div className="ratio ratio-16x9 rounded-4 overflow-hidden shadow-lg">
                  ...
                  <img src="/greenpark.jpg" alt="Green Park" className="img-fluid object-cover water-float" />
                </div>
              </div>
            </div>
          </motion.div>
                ...
                <div className="row g-0">
                  <div className="col-md-5">
                    <div className="ratio ratio-1x1 h-100">
                      <img src="/tata_gotion3.jpg" alt="Lease Solution" className="img-fluid object-cover water-float" />
                    </div>
                  </div>
            ...
            >
              <div className="whatwedo-other-card h-100">
                ...
                <div className="row g-0">
                  <div className="col-md-5">
                    <div className="ratio ratio-1x1 h-100">
                      <img src="/tata_gotion1.png" alt="Maintain Solution" className="img-fluid object-cover water-float" />
                    </div>
                  </div>
                  <div className="col-md-7">
                    <div className="p-4 p-xl-5 h-100 d-flex flex-column">
